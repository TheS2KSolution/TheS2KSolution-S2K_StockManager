package com.nanou.authservice.config.securityConfig;

import com.nanou.authservice.config.rsaConfig.RsaKeyConfig;
import com.nanou.authservice.handlers.CustomAccessDeniedHandler;
import com.nanou.authservice.handlers.CustomAuthenticationHandler;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeRequests(ar -> ar.antMatchers("/h2-console/**", "/swagger-ui/**", "/v3/**", "/public/**","/auth", "/actuator/**").permitAll())
