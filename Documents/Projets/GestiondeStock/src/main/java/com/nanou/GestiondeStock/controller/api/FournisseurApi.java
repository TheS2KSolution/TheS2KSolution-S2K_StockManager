...
public interface FournisseurApi {
    ...
    @ApiOperation(value = "Enregidter un fournisseur", notes = "Cette methode permet d enregistrer ou modifier un fournisseur", response = ClientDto.class)
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "Supprimer un Fournisseur", notes = "Cette methode permet de Supprimer  un Fournisseur par son ID", response = ClientDto.class)
    @ApiResponses(value = {
