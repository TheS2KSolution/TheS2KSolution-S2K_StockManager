...
class CanalTarifScreen extends StatefulWidget {
  @override
  _CanalTarifScreenState createState() => _CanalTarifScreenState();
}

class _CanalTarifScreenState extends State<CanalTarifScreen> {
  String imei = "";
  String iduser = "";
  String login = '';
  String phone = "";
            ...
            Container(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  var donn = dataItem![index]["tarifcanal"];
                  return Container(
                    height: 35,
                    color: (index % 2 == 0)
                        ? Color(0xFFa7a3a3)
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                            ...
                            child: Text(donn[0]["bouquet"].toString(),
                                style: const TextStyle(fontSize: 14.0))),
                        Container(
                            margin: const EdgeInsets.only(right: 15.0),
                            child: Text(donn[0]["montant"].toString(),
