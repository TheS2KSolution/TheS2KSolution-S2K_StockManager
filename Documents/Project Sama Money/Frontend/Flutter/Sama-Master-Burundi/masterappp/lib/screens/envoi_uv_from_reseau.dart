...
class EnvoiUvFromReseau extends StatefulWidget {
  final String? loginAgent;
  final String? numeroAgent;

  const EnvoiUvFromReseau({Key? key, this.loginAgent, this.numeroAgent})
      : super(key: key);
  @override
  _EnvoiUvFromReseauState createState() => _EnvoiUvFromReseauState();
}

class _EnvoiUvFromReseauState extends State<EnvoiUvFromReseau> {
  ...
  void _submitCommand() {
    ...
    if (form!.validate()) {
      showCustomDialogWithImage(context, montant, widget.numeroAgent!);
    }
  }
              ...
              Container(
                ...
                child: Column(children: <Widget>[
                  ...
                  Container(
                      width: 300,
                      padding:
                          EdgeInsets.only(left: 15.0, top: 0.0, right: 15.0),
                      child: Container(
                        //height: 30,
  ...
  _makePostRequest() async {
    String url = 'depot/uv/agent/login';
    Dio dio = Dio();
    ...
    String finalPhone =
        widget.numeroAgent!.replaceAll(RegExp(r"\s\b|\b\s"), "");
