...
class ConversionCommissionScreen extends StatefulWidget {
  const ConversionCommissionScreen({Key? key}) : super(key: key);

  @override
  _ConversionCommissionScreenState createState() =>
      _ConversionCommissionScreenState();
}

class _ConversionCommissionScreenState
    extends State<ConversionCommissionScreen> {
  ...
  Widget _buildMontantConversion() => TextFormField(
              ...
              Container(
                ...
                child: Column(children: <Widget>[
                  Container(
                    ...
                    child: Text(
                      "Vous allez faire une conversion de " +
                          montant +
                          " FBU en UV." +
                      ...
                      children: <Widget>[
                        ...
                        IconButton(
                          onPressed: () {
                            Navigator.of(context).pop();
                            setState(() {
                              // phoneNumberText = phoneTextFieldController.text;
                            });
                            _authenticateUser();
                          },
                          icon: const Icon(
  ...
  _authenticateUser() async {
    ...
    if (getState) {
      ...
      goToInternet();
      print("============================================");
      print("FINGERPRINT CONVERSION COMMISSION WORKS");
      print("============================================");
  ...
  _makePostRequest() async {
    String url = 'conversion/uv/master';
    Dio dio = new Dio();
    ...
    showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            ...
            content: Text(text,
                style: TextStyle(fontSize: 16.0, color: kSamaBleuColor)),
            actions: <Widget>[
              TextButton(
                onPressed: () {
